...
> **Origin note:** This prototype was originally generated by [Kiro](https://aws.amazon.com/kiro/) (AWS), as evidenced by the `.kiro/specs/moleskintag/` directory containing the original design documents, requirements, and implementation plans. The project was later renamed from `moleskintag` to `vault-sidecar` and significantly extended with new features, security hardening, and design refinements.
